...
void DoRPC(const std::shared_ptr<rpc::req> r, std::shared_ptr<rpc::rsp> q)
{
	q->set_data("world"); 
	printf("--DoRPC--\n");
}
...
int main()
{
	natsu::provide<rpc::req, rpc::rsp>(std::bind(DoRPC, std::placeholders::_1, std::placeholders::_2));
